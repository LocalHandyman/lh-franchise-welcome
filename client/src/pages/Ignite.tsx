...
export default function Ignite() {
  ...
  return <div className="ignite">
    ...
    <main id="ignite-main">
      ...
      <section className="ig-section ig-navy"><div className="ig-container"><div className="ig-two ig-align-center"><div><Heading eyebrow="WHO IS SUPPORTING YOU AS A SUCCESS PARTNER?" title="This is seriously a kickass support system to build a business with…" /><h3 className="ig-colin">Colin Sprake</h3><p className="ig-role">Local Handyman Owner & CEO</p><p className="ig-intro">Get to know Colin and the approach behind Local Handyman. His focus is helping Success Partners become confident business owners through mentorship, practical systems, and ongoing support.</p><Booking location="colin" /></div><figure><Video id="68416b6961297813d690a95d" poster="67603c6888b4df022d30c950.png" title="Get to know Colin and Local Handyman" /><figcaption className="ig-caption">A closer look at the leadership behind Local Handyman.</figcaption></figure></div><div className="ig-support-row"><div><Compass aria-hidden="true" /><h3>Business guidance</h3><p>Training and support as you build your operation.</p></div><div><Users aria-hidden="true" /><h3>Partner community</h3><p>Connect, collaborate, and learn from other owners.</p></div><div><TrendingUp aria-hidden="true" /><h3>Marketing support</h3><p>Brand, tools, and resources for local visibility.</p></div></div></div></section>
      ...
      <section className="ig-section ig-fit"><div className="ig-container"><Heading eyebrow="WE’RE LOOKING FOR INDIVIDUALS READY TO BUILD" title="Is Local Handyman Right for You?">This is an active business ownership opportunity for people ready to invest their time, energy, and leadership.</Heading><div className="ig-three">{[["Growth-oriented", "You want to build a team and develop a business in your community."], ["Decisive and driven", "You ask good questions, make informed decisions, and take action."], ["Ready to lead", "You’re willing to follow systems, build relationships, and commit to the work."]].map(([title, text]) => <article key={title}><h3>{title}</h3><p>{text}</p></article>)}</div></div></section>
